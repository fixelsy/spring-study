package com.pjt.lec23.member.controller;
...
import com.pjt.lec23.member.service.MemberService;
...
public class MemberController {
	...
	public String memLogin(Member member, HttpSession session) {
		...
		if (mem == null) return "/member/loginForm";
	...
	public String memRemove(Member member, HttpServletRequest request) {
		...
		if (result == 0) return "/member/removeForm";
