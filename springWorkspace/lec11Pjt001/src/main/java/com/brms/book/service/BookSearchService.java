...
public class BookSearchService implements InitializingBean, DisposableBean {
	...
	public void afterPropertiesSet() throws Exception {
		// InitializingBean
		System.out.println("InitializingBean.afterPropertiesSet() ==> BookSearchService bean 객체 생성");
	...
	public void destroy() throws Exception {
		// DisposableBean
		System.out.println("DisposableBean.destroy() ==> BookSearchService bean 객체 소멸");
