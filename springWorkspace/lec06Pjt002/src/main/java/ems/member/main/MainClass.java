...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		String[] sMajors = {	"English Literature", "Korean Language and Literature",
								...
								"History", "Law", "Statistics", "Computer",
		...
		for (int i = 0 ; i < sNums.length ; i++) {
			Student student = new Student(sNums[i], sIds[i], sPws[i],
		...
		modifyService.modify(new Student("H39lesvj7544vf89", "deer", "00000",
											"melissa" , 26, "W", "Vocal Music"));
